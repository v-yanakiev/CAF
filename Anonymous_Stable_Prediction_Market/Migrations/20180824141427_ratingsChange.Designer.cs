...
namespace ChoresAndFulfillment.Migrations
{
    ...
    [Migration("20180824141427_ratingsChange")]
    partial class ratingsChange
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChoresAndFulfillment.Data.Rating", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<int>("UserGivingRatingId");

                    b.Property<string>("UserGivingRatingId1");

                    b.Property<int>("UserReceivingRatingId");

                    b.Property<string>("UserReceivingRatingId1");

                    b.Property<int>("Value");

                    b.HasKey("Id");

                    b.HasIndex("UserGivingRatingId1");

                    b.HasIndex("UserReceivingRatingId1");
            ...
            modelBuilder.Entity("ChoresAndFulfillment.Data.Rating", b =>
                {
                    b.HasOne("ChoresAndFulfillment.Data.User", "UserGivingRating")
                        .WithMany("RatingsGiven")
                        .HasForeignKey("UserGivingRatingId1");

                    b.HasOne("ChoresAndFulfillment.Data.User", "UserReceivingRating")
                        .WithMany("RatingsReceived")
                        .HasForeignKey("UserReceivingRatingId1");
                });
